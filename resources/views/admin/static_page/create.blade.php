                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="content" id="content" rows="30" class="summernote" placeholder="Content"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
...
@section('customJs')
    ...
    <script>
        ...
        $('#staticPageForm').submit(function(event) {
            event.preventDefault();
            $('button[type=submit]').prop('disabled', true);

            $.ajax({
                url: "{{ route('admin_create_static_page') }}",
                type: 'post',
